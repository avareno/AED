...
public:
    ...
    Change_Class(std::set<Student_class> &students_classes, std::list<Class> &classes, std::string &stu, std::queue<Change> &change_log, std::set<Class_per_uc> &classes_per_uc);
