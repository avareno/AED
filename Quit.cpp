...
Quit::Quit(set<Student_class> &students_classes, set<Class_per_uc> &classes_per_uc, list<Class>&classes, queue<Change> &change_log) {
    // Write classes to "classes_altered.csv"
    ...
    // Write classes_per_uc to "classes_per_uc_altered.csv"
    ...
    // Write students_classes to "students_classes_altered.csv"
    ...
    // Write change_log to "change_log.csv"
